...
$f = fopen("../json/ventas.json", 'w+b'); //Asignamos a la variable $f el fichero en el que queremos guardar nuestro string y las opciones para sobrescribir TODO el contenido.
